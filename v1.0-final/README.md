...
| 차시 | 내용 | 상태 |
|---|---|---|
| 1차시 | 프로젝트 킥오프, 저장소 정리, 환경 구축 | 완료 |
| 2차시 | CSV 데이터 수집·통합·검증 | 완료 |
| 3차시 | EDA, 결측·이상치 정리, 클리닝 | 완료 |
| 4차시 | 특성공학 15개, 스케일링, Window 생성 | 완료 |
| 5차시 | LSTM Point Baseline 학습 및 평가 | 완료 |

후속 차시(6~15차시)는 `NEXT_STEPS_GUIDE.md`에서 분리해 관리합니다.
