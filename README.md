...
| 14주차 | 보고서 작성, 수학적 이론 유도, 코드/결과 연동 | `2026학년도 1학기 더KIUM학기제 결과보고서.*`| 최종 보고서/활동보고서 정리 |
| 15주차 | PPT 자료, 실시간 데모, GitHub 최종 정리, 리허설 및 피드백 반영 | `README.md`, 제출 zip | `kium-p_readme_only_20260610.zip` |
...
*최종 수정: 2026-06-10 | kium-p v1.0-final*# kium-p
...
| 13주차 | 결과 통합, 5개 모델 비교, 논문 수준 시각화 제작 | `notebooks/11_final_compare.py` | `data/models/final_compare.pkl`, `reports/figures/13th_*.png` |
| 14주차 | 보고서 작성, 수학적 이론 유도, 코드/결과 연동 | `2026학년도 1학기 더KIUM학기제 결과보고서.*`| 최종 보고서/활동보고서 정리 |
| 15주차 |  GitHub 최종 정리, 리허설 및 피드백 반영 | `README.md`, 제출 zip | `kium-p_v1.0-final_submission_20260610.zip` |
...
제출용 압축본: `kium-p_readme_only_20260610.zip`
